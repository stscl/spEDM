...
The false nearest neighbours (FNN) ratio decreased to $0$ when the embedding dimension E reached $9$, and remained relatively stable thereafter. Therefore, we adopted $E = 9$ as the embedding dimension for subsequent GCMC analysis.
